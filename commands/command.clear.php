...
class COMMAND_CLEAR
{
	...
	function COMMAND_CLEAR(&$sys_message)
	{
	...
	{
		$this->INTERPRETER->ADD_ACTION($this->NAME,"CLEAR", "CLEAR", "", $this->REQUIRED_FLAG);
		$this->PFLAGS->ADD_FLAG($this->REQUIRED_FLAG);
		$this->INTERPRETER->ADD_ALIAS("CLS", "CLEAR");
		return True;
	}
