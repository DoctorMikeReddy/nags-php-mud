...
class COMMAND_NORTH
{
	var $NAME = "COMMAND_NORTH";
     ...
     function COMMAND_NORTH(&$sys_message)
     {
     ...
     {
          $this->INTERPRETER->ADD_ACTION($this->NAME,"NORTH", "NORTH", "", $this->REQUIRED_FLAG);
          $this->PFLAGS->ADD_FLAG($this->REQUIRED_FLAG);
          $this->INTERPRETER->ADD_ALIAS("N", "NORTH");
          return True;
     }
     function NORTH()
     {
		$socket = $this->SYSTEM->CURRENT_SOCKET;
		$this->MOVEMENT->GO_THROUGH_EXIT("NO");
     }  
}
?>