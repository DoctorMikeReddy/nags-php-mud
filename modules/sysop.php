...
|
|  DESCRIPTION:
|		SYSOP SYSTEM MODULE FOR NAGS GAMING SERVER
|
|  REQUIREMENTS:
...
class SYSOP
{
     ...
     function SYSOP(&$sys_message)
     {
          $this->MESSAGE =& $sys_message;
          $this->MESSAGE->SYSMESSAGE("SYSOP", "SYSTEM", "LOAD MODULE");
          $this->ENABLED = True;
          return True;
     }
     ...
     function DEBUG($mysock, $target)
     {
          $this->COMMUNICATION->SEND_TO_CHAR($this->PLAYER->IS_ONLINE($target));
     }
}
?>